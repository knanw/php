        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/registration/index">Login/ registration</a>
                    </li>
        ...
        <div class="panel panel-login">
          <div class="panel-heading">
            <div class="row">
              ...
              <div class="col-xs-6">
                <a href="<?php echo base_url(); ?>index.php/registration/index" id="register-form-link">Register</a>
              </div>
            </div>
            <hr>
          </div>
